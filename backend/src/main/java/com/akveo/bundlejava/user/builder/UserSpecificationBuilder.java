package com.akveo.bundlejava.user.builder;

import com.akveo.bundlejava.user.User;
import com.akveo.bundlejava.user.filter.UsersGridFilter;
import com.akveo.bundlejava.user.specification.SearchCriteria;
import com.akveo.bundlejava.user.specification.UserSpecification;
